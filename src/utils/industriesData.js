// Industries data for CC-Mating website
export const industries = [
  {
    ...
    description: "Nursing homes contain vulnerable members of our society and it is important that we do all we can to protect them. Having the proper procedures, practices and equipment in place will ensure that the residents at a nursing home are kept safe.",
...
Not only are contamination control mats extremely easy to clean and maintain they can also last up to 5 years if they are maintained correctly. They are also a much cheaper option as well since they do not need to be replaced every few weeks in comparison to peel off matts.`,
  ...
  },
  {
    ...
    description: "Contamination is a major and growing concern in cleanrooms, critical areas and controlled environments of any semi-conductor facility. Although contamination from foot, wheel and airborne particles is often dismissed as simply 'dust' or 'dirt', the dangers it poses can be devastating.",
...
All of these properties combine to ensure that your semi-conductor facility is being optimally protected for both your staff and contractors alike. There is no other proven method in the world today that can remove 99.9% of potential harmful particulates/contaminants from the feet or wheels of trolleys.`,
  ...
  },
  {
    ...
    description: "Infection & contamination control is always a number one priority of any medical or healthcare environment to ensure the highest standards for both patients and staff.",
