    ...
    >
      ...
      <div className="xl:max-w-[1300px] lg:max-w-[1000px] mx-auto px-4 sm:px-6 md:px-8 lg:px-2 py-10 pb-10  md:py-14 lg:py-10 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 xl:gap-16 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-7xl font-bold text-neutral-900 leading-[1.1] tracking-tight"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg lg:text-base xl:text-lg text-left text-neutral-600 max-w-xl leading-relaxed font-medium "
            >
            ...
            {/* Key Highlights - CE Marking, REACH, VOCs */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.7, delay: 0.35 }}
              className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-8 pr-0 sm:pr-10"
            >
              {/* CE Marking */}
              <div className="group w-full inline-flex items-center gap-2 px-3 py-2 rounded-md bg-white/60 backdrop-blur-sm border border-neutral-200/60 shadow-sm hover:shadow-md hover:border-neutral-300/80 transition-all duration-300">
                ...
                <span className="xl:text-xs lg:text-[10px] text-[10px] font-medium text-neutral-700 tracking-wide">CE Marking</span>
              </div>

              {/* BPR - EPA Compliance */}
              <div className="group w-full xl:text-nowrap inline-flex items-center gap-2 px-3 py-2 rounded-md bg-white/60 backdrop-blur-sm border border-neutral-200/60 shadow-sm hover:shadow-md hover:border-neutral-300/80 transition-all duration-300">
                ...
                <span className="xl:text-xs lg:text-[10px] text-[10px] font-medium text-neutral-700 tracking-wide">REACH Compliance</span>
              </div>
              ...
              <div className="group w-full inline-flex items-center gap-2 px-5 py-2 rounded-md bg-white/60 backdrop-blur-sm border border-neutral-200/60 shadow-sm hover:shadow-md hover:border-neutral-300/80 transition-all duration-300">
                ...
                <span className="xl:text-xs lg:text-[10px] text-[10px] font-medium text-neutral-700 tracking-wide">VOC's Tested</span>
              </div>
            ...
            >
              <ABTestCTA
                ...
                location="hero"
                className="btn-primary text-nowrap inline-flex items-center justify-center px-4.5 py-2.5 sm:px-7 sm:py-3 md:px-8 md:py-3.5 text-xs sm:text-base font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
              />
              <Link
                href="/videos"
                onClick={onSecondaryClick}
                className="btn-secondary text-nowrap inline-flex items-center justify-center px-4.5 py-2.5 sm:px-7 sm:py-3 md:px-8 md:py-3.5 text-xs sm:text-base font-semibold border-2 hover:border-primary/50 transition-all duration-300"
              >
                <svg
            ...
            <motion.div
              ...
              className="min-[380px]:flex sm:text-left text-center grid grid-cols-2 justify-between items-center pr-5 gap-10 pt-8 border-t border-neutral-200/60"
            >
              <div className=''>
        ...
        <video
          ...
          playsInline
          className="
            lg:absolute max-w-full h-auto bottom-10 left-1/2
            w-auto 
            z-0
            mix-blend-multiply
            md:w-auto lg:left-[300px] xl:top-[-130px] xl:left-[430px] xl:translate-x-0 xl:bottom-auto xl:z-auto
          "
        >
