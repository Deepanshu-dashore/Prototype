...
export const metadata = {
  ...
  description:
    "Explore the technical benefits of CC Matting. Up to 99% particle retention, 8+ overstrikes, silver biocide antimicrobial properties, and a 4-5 year lifecycle.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Proven Up to 99% particle retention and antimicrobial protection. Discover the technology behind our high-performance polymeric mats.",
