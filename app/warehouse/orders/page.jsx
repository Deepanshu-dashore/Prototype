                    ...
                    <div className="overflow-x-auto w-[calc(100vw-3.5rem)] md:w-[calc(100vw-2rem)] lg:w-auto relative">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {loading ? (
                                    <TableLoadingSkeleton rows={5} columns={9} />
                                ) : error ? (
                                    <tr>
                                        <td colSpan="9" className="px-6 py-12 text-center text-red-500">{error}</td>
                                    </tr>
                                ) : orders.length === 0 ? (
                                    <TableEmptyState
                                        colSpan={9}
                                        ...
                                        <tr key={order._id} className={`hover:bg-gray-50/60 transition-colors ${index % 2 !== 0 ? 'bg-slate-50' : 'bg-white'}`}>
                                            ...
                                            <td className="py-4 pr-2">
                                                <div className="flex flex-col gap-1 justify-center">
                                                    {order.qc ? (
                                                        <span title="QC Complete" className="text-xs bg-indigo-50 text-indigo-700 p-2 rounded border border-indigo-100 w-fit font-mono">
                                                        ...
                                                        <span title="QC Pending" className="text-xs text-gray-400 p-1 bg-slate-100 rounded border border-slate-100 w-fit font-mono">
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="inline-flex items-center gap-1.5 px-2 py-2 bg-red-50 border border-red-200 text-red-600 rounded-md hover:bg-red-100 transition-all shadow-sm"
                                                        title="Delete Order"
                                                    >
