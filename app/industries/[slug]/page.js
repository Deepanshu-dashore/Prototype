...
import { getIndustryBySlug, getAllIndustries } from "../../../src/utils/industriesData";
import { notFound } from "next/navigation";

export default function IndustryPage({ params }) {
  const unwrappedParams = use(params);
  const industry = getIndustryBySlug(unwrappedParams.slug);
      ...
      <main className="grow">
        ...
        {industry.benefits && industry.benefits.length > 0 && (
          <section className="relative py-16 sm:py-20 overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-primary/5 to-gray-50" />
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-10 items-center">
                {/* Left Side - Badge, Heading with Description */}
                <motion.div
                ...
                {/* Right Side - Benefits in 2 Columns */}
                  ...
                  >
                    <Link href={`/industries/${relatedIndustry.slug}`}>
                      <div className="bg-white border border-gray-200 rounded-lg p-6 hover:border-primary/30 hover:shadow-md transition-all duration-300 h-full flex flex-col group">
                        ...
                        {/* Short Description */}
                        <p className="text-sm sm:text-base text-neutral-dark/60 mb-6 leading-relaxed flex-grow line-clamp-3">
