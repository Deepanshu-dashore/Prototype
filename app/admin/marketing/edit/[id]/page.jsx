                    ...
                    {isSocialPost && (
                        <div className="animate-in zoom-in duration-500">
                            ...
                            {existingAttachment && !file && (
                                <div className="mb-6 flex flex-col gap-2 p-3 rounded-xl bg-blue-50 border border-blue-200">
                                    <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                <div className="text-center">
                                    {file ? (
                                        ...
                                        <>
                                            <p className="text-base font-bold text-slate-600">Drop your new {form.attachmentType} here</p>
                            ...
                            >
                                ...
                                <div className="text-center">
                                    {file ? (
                                        ...
                                        <>
                                            <p className="text-base font-bold text-slate-600">Drop your new PDF here</p>
