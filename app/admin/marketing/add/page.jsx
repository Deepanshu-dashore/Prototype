            ...
            <div className="max-w-4xl mx-auto p-6 flex flex-col gap-6">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col gap-4">
                    ...
                    {isSocialPost && (
                        <div>
                            <label className="bg-white font-semibold px-2 inline-block mb-1.5 text-sm text-gray-700 tracking-tight">
                                Social Post Media <span className="text-red-500">*</span>
                            </label>
                            <div
                            ...
                            >
                                ...
                                {file ? (
                                    ...
                                    <>
                                        <p className="text-sm font-semibold text-gray-600">Drop your {form.attachmentType} here or click to browse</p>
                                        <p className="text-xs text-gray-400">Supported for {form.attachmentType} uploads</p>
                                    </>
                                )}
                                <input
                                    ref={mediaFileRef}
