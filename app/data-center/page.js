...
export const metadata = {
  title: "Data Center Contamination Control & Entrance Protection | CC Matting Ireland",
  description:
    "Safeguarding High-Density Compute, ISO Class 5 Air Quality, and Operational Uptime at the Floor Level with CC Matting contamination control systems.",
  alternates: {
    canonical: "https://ccmatting.ie/data-center",
  },
  openGraph: {
    title: "Data Center Contamination Control | CC Matting Ireland",
    description:
      "Floor-level contamination control for high-density compute, server halls, and ISO Class 5 data centers.",
    url: "https://ccmatting.ie/data-center",
    siteName: "CC Matting",
    locale: "en_IE",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Data Center Contamination Control",
      },
    ],
  },
  twitter: {
