    ...
    <PublicLayout className="bg-white">
      <main className="grow bg-white pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <h1 className="text-3xl lg:text-4xl font-bold text-neutral-dark mb-8">
          ...
          <div className="prose prose-neutral max-w-none space-y-8 text-neutral-dark/80 leading-relaxed">
            <section>
              ...
              <p>
                CC Matting provides a <strong>100% 3-year warranty</strong> on
                its contamination control floor mats. We guarantee that the CC
                Matting polymer floor surface will continue to remove and hold
                foot and wheel-borne contamination at an equal or greater
                quantity than a new adhesive, disposable mat for a period of{" "}
                <strong>36 months</strong>.
              </p>
              <p className="mt-4">
                A properly installed CC Matting floor mat system is expected to
                have an average active life of <strong>5 years</strong> if
            ...
            <section>
              ...
              <p>
                To maintain the validity of the warranty, the floor surface must
                be regularly cleaned in accordance with manufacturer
                instructions. This requirements include:
              </p>
              <ul className="list-disc list-inside space-y-2 mt-2">
                <li>
                  Daily cleaning with a detergent/disinfectant water solution.
                </li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 mt-2">
                ...
                <li>
                  Improper cleaning techniques or use of unapproved chemicals.
                </li>
              </ul>
              <p className="mt-4 italic">
                Note: Traffic should move straight across the floor mat. For
                vehicles making slight turns, the CC Matting Heavy Duty product
                is recommended.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                laws of <strong>Ireland</strong>. CC Matting (Trade and Consult
                Europe Sp.Z.O.O) and yourself both agree to submit to the
            ...
            <section>
              ...
              <p>
                ...
                to this contract shall be determined by one arbitrator chosen in
                accordance with the rules of the European Court of Arbitration.
                The seat of arbitration shall be Cork, Ireland.
              </p>
            </section>
            ...
            <section
              id="contact"
              className="mt-12 bg-neutral-900 text-white p-8 rounded-3xl"
            >
              ...
              <p className="opacity-80">
                Unit 14, Riverstick Industrial Estate
              </p>
              <p className="opacity-80">Riverstick, Co. Cork, Ireland</p>
              <p className="mt-4">
                <span className="font-semibold">Phone:</span> +353 21 470 1669
                <br />
