...
function StatusBadge({ status }) {
    ...
    const cfg = {
        ...
        PROCESSED: "bg-blue-50 text-blue-600 border border-blue-200",
        SHIPPEMENT: "bg-indigo-50 text-indigo-600 border border-indigo-200",
                            ...
                            <div className="flex items-end gap-4">
                                ...
                                <div className="pb-1 drop-shadow-md">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 bg-blue-500 rounded-full p-1" viewBox="0 0 256 256">
